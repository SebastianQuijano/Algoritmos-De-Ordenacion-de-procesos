 ...
 * @author Brownie
 */
public class FcfsInterfaz extends javax.swing.JFrame {
        MetodosFcfs a;
    ...
    public FcfsInterfaz() {
        ...
        a = new MetodosFcfs();
        setTitle("Planificación de Procesos: FCFS");
    ...
    public  void iniciar() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FcfsInterfaz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FcfsInterfaz().setVisible(true);
